...
export default class CreateRoomPage extends Component{
    ...
    handleRoomButtonPressed(){ //created the method
        ...
        //fetch method of react like python's reqeust
        // we made a django view under /api/createroom with a post method
        // and the response of the method is now logged
